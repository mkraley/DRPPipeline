...
class TestFileUtils(unittest.TestCase):
    ...
    def test_parse_file_size_to_bytes(self) -> None:
        ...
        self.assertEqual(file_utils.parse_file_size_to_bytes("159 bytes"), 159)
        self.assertEqual(file_utils.parse_file_size_to_bytes("856 bytes"), 856)
        self.assertEqual(file_utils.parse_file_size_to_bytes("1 byte"), 1)
